...
<link rel="stylesheet" href="css/button.css">
 ...
 <body>
		<header>
			...
			<%ArrayList<User>admin=(ArrayList) request.getAttribute("users");%>
			<div class="header">
				<section class="text-gray-700 body-font">
				  <div class="container px-5 py-24 mx-auto">
					<div class="flex flex-col text-center w-full mb-20">
					  <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">All users</h1>
					  ...
					  <table class="table-auto w-full text-left whitespace-no-wrap">
						<thead>
						  <tr>
							...
							<th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-200">User Name</th>
						...
						<%if (admin!=null){%>
						  ...
						  <tr style="color:white;">
							<td class="px-4 py-3"><%=user.getUserId()%></td>
