		...
		<header>
			...
			<div class="display-content">
				...
				<section class="text-gray-700 body-font">
						...
						<H1 class="sm:w-2/5 text-grey-900 font-medium title-font text-2xl mb-2 sm:mb-0 top-heading" align="center"><b>JABALPUR</b></h1>
							  </div>
							</div>
							<div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 ">
							  <div class="p-4 md:w-1/3 sm:mb-0 mb-6 disp">
								<div class="rounded-lg h-64 overflow-hidden">
								  <img class="object-cover object-center h-full w-full" src="images/df.jpg" alt="Dhuandhar Falls">
								</div>
							  ...
							  <div class="p-4 md:w-1/3 sm:mb-0 mb-6 disp">
								<div class="rounded-lg h-64 overflow-hidden">
								  <img  class="object-cover object-center h-full w-full" src="images/mm.jpg" alt="Madan Mahal Fort">
								</div>
							  ...
							  <div class="p-4 md:w-1/3 sm:mb-0 mb-6 disp">
								<div class="rounded-lg h-64 overflow-hidden">
								  <img class="object-cover object-center h-full w-full" src="images/dn.jpg" alt="Dumna Nature Reserve Park">
								</div>
							  ...
							  <div class="p-4 md:w-1/3 sm:mb-0 mb-6 disp2">
								<div class="rounded-lg h-64 overflow-hidden">
								  <img  class="object-cover object-center h-full w-full" src="images/pk.jpg" alt="Pisanhari ki Madiya">
								</div>
							  ...
							  <div class="p-4 md:w-1/3 sm:mb-0 mb-6 disp2">
								<div class="rounded-lg h-64 overflow-hidden">
								  <img  class="object-cover object-center h-full w-full" src="images/rd.jpg" alt="Rani Durgavati Museum">
								</div>
							  ...
							  <div class="p-4 md:w-1/3 sm:mb-0 mb-6 disp2">
								<div class="rounded-lg h-64 overflow-hidden">
								  <img class="object-cover object-center h-full w-full" src="images/br.jpg" alt="Balancing Rock">
								</div>
						...
						<section class="text-gray-700 body-font">
						  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col single">
							<img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded"  src="images/df.jpg" alt="Dhuandhar Falls">
							<div class="text-center lg:w-2/3 w-full">
					<h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900" >Dhuandhar Falls</h1>
						...
						<section class="text-gray-700 body-font">
						  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col single">
							<img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded"src="images/mm.jpg" alt="Madan Mahal Fort">
							<div class="text-center lg:w-2/3 w-full">
							  <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Madan Mahal Fort</h1>
						...
						<section class="text-gray-700 body-font">
						  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col single">
							<img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" src="images/dn.jpg" alt="Dumna Nature Reserve Park">
							<div class="text-center lg:w-2/3 w-full">
							  <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Dumna Nature Reserve Park</h1>
						...
						<section class="text-gray-700 body-font">
						  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col single">
							<img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" src="images/pk.jpg" alt="Pisanhari ki Madiya">
							<div class="text-center lg:w-2/3 w-full">
							  <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Pisanhari ki Madiya</h1>
...
grinding of wheat floor by hand driven grinder was the only source of income for her. But she didn&#39;t lose hope and worked harder to earn more. When she collected sufficient money she went on the hill top and began building the temple.With the little help of the other villagers she  completed the Jain temple. But she was left with no money to install gold pots on the top of pinnacle. Thus she decided to place her last assets the two stones of her floor grinder on the top of pinnacle.The stones places by the women are still present on the temple thus symbolizing her dedication. To pay a tribute to her this  place is named “Pisanhari ki Marhiyaa”, meaning the temple of the -Pisanhari (the woman preparing wheat floor on hand operated stone-mill). The Pisanhari Ki Madiya is full of lush greenery and  eye catching beautiful hilly area. The surrounding is perfect for meditation and other rituals.  It is a very </p>
						...
						<section class="text-gray-700 body-font">
						  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col single">
							<img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" src="images/rd.jpg" alt="Rani Durgavati Museum">
							<div class="text-center lg:w-2/3 w-full">
							  <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Rani Durgavati Museum</h1>
						...
						<section class="text-gray-700 body-font">
						  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col single">
							<img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" src="images/br.jpg" alt="Balancing Rock">
							<div class="text-center lg:w-2/3 w-full">
							  <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Balancing Rock</h1>
