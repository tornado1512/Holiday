		...
		<header>
			...
			<div class="display-content">
				...
				<section class="text-gray-700 body-font">
						...
						<H1 class="sm:w-2/5 text-grey-900 font-medium title-font text-2xl mb-2 sm:mb-0 top-heading" align="center"><b>INDORE</b></h1>
							  </div>
							</div>
					...
					<h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900" >Lalbagh Palace</h1>
						...
						<section class="text-gray-700 body-font">
						  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col single">
							...
							<div class="text-center lg:w-2/3 w-full">
							  <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Khajrana Ganesh Temple</h1>
						...
						<section class="text-gray-700 body-font">
						  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col single">
							...
							<div class="text-center lg:w-2/3 w-full">
							  <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Kanch Mandir</h1>
						...
						<section class="text-gray-700 body-font">
						  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col single">
							...
							<div class="text-center lg:w-2/3 w-full">
							  <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Rajwada</h1>
						...
						<section class="text-gray-700 body-font">
						  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col single">
							...
							<div class="text-center lg:w-2/3 w-full">
							  <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Patalpani Waterfall</h1>
						...
						<section class="text-gray-700 body-font">
						  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col single">
							...
							<div class="text-center lg:w-2/3 w-full">
							  <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Annapurna Temple</h1>
