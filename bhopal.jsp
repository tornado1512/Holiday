		...
		<header>
			...
			<div class="display-content">
				...
				<section class="text-gray-700 body-font">
						...
						<H1 class="sm:w-2/5 text-grey-900 font-medium title-font text-2xl mb-2 sm:mb-0 top-heading" align="center"><b>CITY OF LAKE- BHOPAL</b></h1>
							  </div>
							</div>
							<div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 ">
							  <div class="p-4 md:w-1/3 sm:mb-0 mb-6 disp">
								<div class="rounded-lg h-64 overflow-hidden">
								  <img class="object-cover object-center h-full w-full"  src="images/vv.png" alt="Van Vihar National Park">
								</div>
							  ...
							  <div class="p-4 md:w-1/3 sm:mb-0 mb-6 disp">
								<div class="rounded-lg h-64 overflow-hidden">
								  <img  class="object-cover object-center h-full w-full" src="images/bt.jpg" alt="Bhojpur Temple">
								</div>
							  ...
							  <div class="p-4 md:w-1/3 sm:mb-0 mb-6 disp">
								<div class="rounded-lg h-64 overflow-hidden">
								  <img class="object-cover object-center h-full w-full"src="images/nm.jpg" alt="National Museum of Mankind">
								</div>
							  ...
							  <div class="p-4 md:w-1/3 sm:mb-0 mb-6 disp2">
								<div class="rounded-lg h-64 overflow-hidden">
								  <img  class="object-cover object-center h-full w-full" src="images/sa.jpg" alt="State Archaeological Museum">
								</div>
							  ...
							  <div class="p-4 md:w-1/3 sm:mb-0 mb-6 disp2">
								<div class="rounded-lg h-64 overflow-hidden">
								  <img  class="object-cover object-center h-full w-full" src="images/bb.jpg" alt="Birla Museum">
								</div>
							  ...
							  <div class="p-4 md:w-1/3 sm:mb-0 mb-6 disp2">
								<div class="rounded-lg h-64 overflow-hidden">
								  <img class="object-cover object-center h-full w-full" src="images/ln.jpg" alt="Lakshmi Narayan Temple">
								</div>
						...
						<section class="text-gray-700 body-font">
						  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col single">
							<img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded"   src="images/vv.png" alt="Van Vihar National Park">
							<div class="text-center lg:w-2/3 w-full">
					<h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900" >Van Vihar National Park</h1>
						...
						<section class="text-gray-700 body-font">
						  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col single">
							<img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" src="images/bt.jpg" alt="Bhojpur Temple">
							<div class="text-center lg:w-2/3 w-full">
							  <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Bhojpur Temple</h1>
						...
						<section class="text-gray-700 body-font">
						  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col single">
							<img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" src="images/nm.jpg" alt="National Museum of Mankind">
							<div class="text-center lg:w-2/3 w-full">
							  <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">National Museum of Mankind</h1>
						...
						<section class="text-gray-700 body-font">
						  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col single">
							<img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" src="images/sa.jpg" alt="State Archaeological Museum">
							<div class="text-center lg:w-2/3 w-full">
							  <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">State Archaeological Museum</h1>
						...
						<section class="text-gray-700 body-font">
						  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col single">
							<img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" src="images/bb.jpg" alt="Birla Museum">
							<div class="text-center lg:w-2/3 w-full">
							  <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Birla Museum</h1>
						...
						<section class="text-gray-700 body-font">
						  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col single">
							<img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" src="images/ln.jpg" alt="Lakshmi Narayan Temple">
							<div class="text-center lg:w-2/3 w-full">
							  <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Lakshmi Narayan Temple</h1>
