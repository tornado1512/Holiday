					  ...
					  <table class="table-auto w-full text-left whitespace-no-wrap">
						<thead>
						  <tr>
							...
							<th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-200">Owner</th>
							<th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-200">City</th>
						  </tr>
						</thead>
						<tbody>
							<%for(RestRegister rest:admin){%>
						  <tr style="color:white;">
							<td class="px-4 py-3"><%=rest.getRestRegisterId()%></td>
							<td class="px-4 py-3"><%=rest.getRestName()%></td>
							<td class="px-4 py-3"><%=new RegisterOwner(rest.getOwnerId()).getOwnerName2()%></td>
							<td class="px-4 py-3 text-lg text-gray-900" style="color:white;"><%=rest.getCity().getCityName()%></td>
